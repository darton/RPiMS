...
```
RPi [GND] -------- GND for all Sensors
RPi [GPIO.21] ---- [Output] (Door/window sensor 1)
...
RPi [GPIO.18 - pin 13] --- [Output] (Motion sensor 3)
RPi [GPIO.18 - pin 19] --- [Output] (Motion sensor 4)
RPi [GPIO.18 - pin 26] --- [Output] (Motion sensor 5)
```

...
sudo apt-get -y install git-core python3-gpiozero python3-pip build-essential python3-dev python3-numpy python3-picamera redis-server php php-fpm php-redis zabbix-agent libfreetype6-dev libopenjp2-7 libjpeg-dev build-essential p7zip-full
...
7zip x 1.44inch-LCD-HAT-Code.7z

...
for file in ADHT.py BME280.py CPUtemp.py DS18B20.py sensors.py redis-get.py redis-get-ds18b20.py redis-get-logdata.py stream.sh videorecorder.sh zabbix_sender.sh zabbix-rpims.conf README.md index.php nginx-default motd rc.local luma_oled.py luma_lcd.py; do

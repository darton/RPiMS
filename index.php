...
if ($rpims["use_CPU_sensor"] == 1) {
    print "<p style='color:blue;'>RPiMS CPU Temperature : " . round($rpims["CPU_Temperature"],2) . " °C</p>";
}
...
if ($rpims["use_BME280_sensor"] == 1) {
    ...
    print "<p style='color:green;'>BME280 Pressure : " . round($rpims["BME280_Pressure"],2) . " hPa</p>";
}
...
if ($rpims["use_DHT22_sensor"] == 1) {
    ...
    print "<p style='color:green;'>DHT22 Humidity : " . round($rpims["DHT22_Humidity"],2) . " %</p>";
}
...
if ($rpims["use_door_sensor"] == 1) {
    ...
    print "<p style='color:brown;'>Door sensor 2 : " . $rpims["door_sensor_2"] . "</p>";
}
#if ($rpims["use_door_sensor"] == 1) {
...
if ($rpims["use_motion_sensor"] == 1) {
    ...
    print "<p style='color:red;'>Motion_sensor_5 : " . $rpims["motion_sensor_5"] . "</p>";
}
#if ($rpims["use_motion_sensor"] == 1) {
#    print "<p style='color:red;'><b>Motion sensors</b></p>";
#    foreach ($rpimskeys as $key)

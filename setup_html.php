...
<div class="w3-row-padding w3-yellow">
    ...
    <div class="w3-quarter w3-container w3-yellow w3-margin-top w3-margin-bottom">
...
<div class="w3-row w3-yellow">
    <div class="w3 w3-container w3-yellow w3-margin-top">
...
<?php
	...
	echo "<div class='w3-row w3-yellow w3-margin-top w3-margin-bottom'>";
	echo "<div class='w3-third w3-container w3-yellow w3-margin-bottom'>";
	echo "Address:";
	echo "<input class='w3-input' type='text' value='$value'>";
	echo "</div>";
	
	echo "<div class='w3-twothird w3-container w3-yellow w3-margin-bottom'>";
	echo "name :";
...
<div class="w3-row-padding w3-green w3-margin-top">
    <p>
...
<div class="w3-row w3-yellow">
<div class="w3-row w3-yellow w3-margin-bottom">
    <div class="w3-quarter w3-container w3-yellow w3-margin-top">
	<label>name:</label>
...
<div class="w3-row w3-yellow w3-margin-top">
    <div class="w3-row-padding w3-green">
	<p>
...
<div class="w3-row w3-yelow w3-margin-bottom">
    <div class="w3-third w3-container w3-yellow w3-margin-top">
...
<div class="w3-row-padding w3-yellow w3-margin-bottom">
    <div class="w3-quarter w3-container w3-yellow w3-margin-top">
...
echo "<div class='w3-row w3-yellow w3-margin-bottom'>";
echo "<br>";
echo "<div class='w3-half w3-container w3-yellow w3-margin-bottom'>";
...
echo "</select>";
echo "</div>";
echo "<div class='w3-quarter w3-container w3-yellow w3-margin-bottom'>";
...
<div class="w3-row w3-yellow">
    <p>
    <div class="w3-third w3-container w3-yellow w3-margin-bottom">
...
<div class="w3-row w3-yellow">
    <div class="w3-half w3-container w3-yellow w3-margin-bottom">

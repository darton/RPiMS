...
<option <?php if ($id2_BME280_serial_port == '/dev/ttyACM0') echo 'selected="selected"'; ?> value = "/dev/ttyACM0" >/dev/ttyACM0</option>
<option <?php if ($id2_BME280_serial_port == '/dev/ttyACM1') echo 'selected="selected"'; ?> value = "/dev/ttyACM1" >/dev/ttyACM1</option>
<option <?php if ($id2_BME280_serial_port == '/dev/ttyACM2') echo 'selected="selected"'; ?> value = "/dev/ttyACM2" >/dev/ttyACM2</option>
<option <?php if ($id2_BME280_serial_port == '/dev/ttyACM3') echo 'selected="selected"'; ?> value = "/dev/ttyACM3" >/dev/ttyACM3</option>
</select>
</label>
</td>
</tr>
...
<option <?php if ($id3_BME280_serial_port == '/dev/ttyACM0') echo 'selected="selected"'; ?> value = "/dev/ttyACM0" >/dev/ttyACM0</option>
<option <?php if ($id3_BME280_serial_port == '/dev/ttyACM1') echo 'selected="selected"'; ?> value = "/dev/ttyACM1" >/dev/ttyACM1</option>
<option <?php if ($id3_BME280_serial_port == '/dev/ttyACM2') echo 'selected="selected"'; ?> value = "/dev/ttyACM2" >/dev/ttyACM2</option>
<option <?php if ($id3_BME280_serial_port == '/dev/ttyACM3') echo 'selected="selected"'; ?> value = "/dev/ttyACM3" >/dev/ttyACM3</option>
</select>
</label>
</td>
</tr>

...
<option <?php if ($id2_BME280_2_interface == 'serial') echo 'selected="selected"'; ?> value = "serial" >serial</option>
</select>
</td>
<td>
<label id="id2_BME280_serial_port">Serial port:
<select name="id2_BME280_serial_port" class="w3-input" >
<option <?php if ($id3_BME280_serial_port == '/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.1:1.0') echo 'selected="selected"'; ?> value = "/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.1:1.0" >USB1</option>
<option <?php if ($id3_BME280_serial_port == '/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.2:1.0') echo 'selected="selected"'; ?> value = "/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.2:1.0" >USB2</option>
<option <?php if ($id3_BME280_serial_port == '/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.3:1.0') echo 'selected="selected"'; ?> value = "/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.3:1.0" >USB3</option>
<option <?php if ($id3_BME280_serial_port == '/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.4:1.0') echo 'selected="selected"'; ?> value = "/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.4:1.0" >USB4</option>
</select>
</label>
</td>
</tr>
...
<option <?php if ($id3_BME280_2_interface == 'serial') echo 'selected="selected"'; ?> value = "serial" >serial</option>
</select>
</td>
<td>

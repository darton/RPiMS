...
<td>
<input name="TLSPSKIdentity" type="text" size="17" value="<?=$TLSPSKIdentity?>">
</td>
<td>
<input type="button" onclick="gfg_Run(16,pski_gen)" value="Generate PSK Identity">
</td>
<td id="pskidentity">
</td>
</tr>
...
<td>
<input name="TLSPSK" type="text" size="65" value="<?=$TLSPSK?>" >
</td>
<td>
<input type="button" onclick="gfg_Run(64,psk_gen)" value="Generate PSK">
</td>
<td id="psk">
</td>
</tr>
...
<input type="submit" value="Save" class="w3-bar">
    ...
    <script>
        var psk_gen = document.getElementById("psk");
        var pski_gen = document.getElementById("pskidentity");
        ...
        function gfg_Run(psk_len,item) {
            item.innerHTML = generateP(psk_len);
            document.getElementById("TLSPSKIdentity").value = document.getElementById("pskidentity").value
        }
    </script>

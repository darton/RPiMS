...
$id1_BME280_read_name = $rpims['sensors']['BME280']['id1']['name'];
...
$id2_BME280_read_name = $rpims['sensors']['BME280']['id1']['name'];
...
$id3_BME280_read_name = $rpims['sensors']['BME280']['id1']['name'];

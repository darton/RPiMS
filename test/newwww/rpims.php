...
if ($config["use_BME280_sensor"] == true){
    $rpims_api["sensors"]["bme280"][1]["i2c_address"] = $config["BME280_i2c_address"];
    $rpims_api["sensors"]["bme280"][1]["read_interval"] = $config["BME280_read_interval"];
    $rpims_api["sensors"]["bme280"][1]["temperature"] = $rpims["BME280_Temperature"];
    $rpims_api["sensors"]["bme280"][1]["humidity"] = $rpims["BME280_Humidity"];
    $rpims_api["sensors"]["bme280"][1]["pressure"] = $rpims["BME280_Pressure"];

    $rpims_api["sensors"]["bme280"][2]["i2c_address"] = $config["BME280_i2c_address"];
    $rpims_api["sensors"]["bme280"][2]["read_interval"] = $config["BME280_read_interval"];
    $rpims_api["sensors"]["bme280"][2]["temperature"] = $rpims["BME280_Temperature"];
    $rpims_api["sensors"]["bme280"][2]["humidity"] = $rpims["BME280_Humidity"];
    $rpims_api["sensors"]["bme280"][2]["pressure"] = $rpims["BME280_Pressure"];
}
